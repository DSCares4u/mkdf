            ...
            <div class="main-banner">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="cs-text">
                            <a href="#" class="btn-education">Child Sponsorship Program</a>
                            <h2>With Child Sponsorship, you can build a personal connection with a child</h2>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Child Sponsorship Program</h4>
                                        </div>
                                        <div class="modal-body">
                                        	<p>
                                            	With your contribution, a child will have the opportunity to advance in their own personal development and grow up in an environment where he or she can have a happy and productive childhood. Below, we have given you an overview of what you are able to provide and additional information about the benefits of the program. Make a difference today – Sponsor a child! Child Sponsorship is a unique and personal way for you to make a difference in the lives of children.You can help break the cycle of poverty and begin a cycle of progress for children, their families and their entire community and see the difference you are making in their lives first-hand! By just donating Rs 750 for a month, your charitable donations will provide essentials like education, healthcare, clean water, sanitation, and livelihood opportunities so children can have a brighter future.With Child Sponsorship, you can build a personal connection with a child in a developing country who lives in a community that needs your help. You’ll see the difference you are making through letter writing, annual updates and the opportunity to visit your sponsored child. The “Sponsor a Child” program enables sponsors to form a connection with a specific child. The child receives the financial support it needs to develop personally and academically. As a sponsor, you can follow the progress of your child and see how your contribution positively influences his or her development. We also encourage you to stay in touch with your child, to become a role model and influence the progress of him or her directly.
                                            </p>
                                        </div>
                            ...
                            <ul class="cs-check-list row">
                                <li class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><i class="icon-check-circle"></i> Started working in 2023</li>
                                <li class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><i class="icon-check-circle"></i> 320 projects funded</li>
                                <li class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><i class="icon-check-circle"></i> Completed: January 2024</li>
                                <li class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><i class="icon-check-circle"></i> ₹ 1,000,000 invested</li>
                                <li class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><i class="icon-check-circle"></i> Mandatory Child Sponser</li>
                                <li class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><i class="icon-check-circle"></i> Started working in 2023</li>
                            </ul>
                            <div class="cs-gps">
                                <em>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="cs-media" style="margin-top: 20px">
                            <figure><img src="{{ static_asset('assets/assets_web/extra-images/nimg30.jpg')}}" alt="#"></figure>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="cs-counter small">
                                        	<ul>
                                            	<li>
                                                    ...
                                                    <p><strong>Rs.</strong><strong class="counter-small">58,710 </strong> Total</p>
                                                </li>
                                                <li>
                                                	<div class="cs-media">
                                                ...
                                                <li>
                                                    ...
                                                    <p><strong class="counter-small">591 </strong> Donors</p>
                                                </li>
                                                <li>
                                                	<div class="cs-media">
                                                    	<figure><img src="{{ static_asset('assets/assets_web/images/icon-calender-x.png')}}" alt="#"></figure>
                                                    </div>
                                                    <p><strong class="counter-small">23</strong> August 2023</p>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
