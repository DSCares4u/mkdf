            ...
            <div class="main-banner">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="cs-text">
                            <a href="#" class="btn-education">Women Empowerment</a>
                            <h2>Womens are considered as the backbone of Indian society</h2>
                            <span><i class="icon-map-marker"></i> India</span>
                            <p>
                                The entire society gets the benefit when we work towards women. But regrettably, in a country like India, women do not get access even to their basic rights like health, education, employment, and most importantly respectable status in society. In the world population, women population constitutes almost 50% and it is sad to know that most women around the globe are unemployed due to which our nation is suffering economically.Women play an important role and are considered as the backbone of our Indian society and this is the reason why women's empowerment is important. At Nirmala Foundation, we have launched several women empowerment programs in collaboration with the social service center. Through women empowerment programs, we create an environment for the women where they are given the chance to make their own decisions and for society as well.
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Women Empowerment</h4>
                                        </div>
                            ...
                            <ul class="cs-check-list row">
                                ...
                                <li class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><i class="icon-check-circle"></i> Mandatory Women Empowerment</li>
                                <li class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><i class="icon-check-circle"></i> Started working in 2023</li>
                            </ul>
                            <div class="cs-gps">
                                <em>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="margin-top: 20px">
                        <div class="cs-media">
                            <figure><img src="{{ static_asset('assets/assets_web/extra-images/nimg29.jpg')}}" alt="#"></figure>
                        </div>
                    </div>
                </div>
            </div>
