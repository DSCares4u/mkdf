...
@section('content')
	...
	<main id="main">
		<div class="main-section">
			{{-- <div class="page-section" style=" margin-top:-30px; background:#f4f4f4; border-bottom:1px solid #e7e7e7;-webkit-box-shadow: inset 0px 10px 5px -6px rgba(0,0,0,0.25);-moz-box-shadow: inset 0px 10px 5px -6px rgba(0,0,0,0.25);box-shadow: inset 0px 10px 5px -6px rgba(0,0,0,0.25);">
				<div class="container">
					<div class="row">
                    	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        	<ul class="cs-navigator-holder">
                            	<li class="cs-prev"><a href="#">Every water project needs repairs to keep</a></li>
                                <li class="cs-th"><a href="#"><i class="icon-th"></i></a></li>
                                <li class="cs-next"><a href="#">Every water project needs repairs to keep</a></li>
                            </ul>
                        </div>
                    </div>
				</div>
                	...
                	<div class="row">
                    	<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        	<div class="project-holder">
                            	<div class="row">
                                	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    	<a class="btn-education" href="#">Homes For Old Age Peoples</a>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="cs-section-title" style="margin-bottom:27px;">
                                            <h2 style="text-align:left;">Every old age Home residents will be family</h2>
                                            <span><i class="icon-map-marker"></i> Khatmando, Nepal</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    	<div class="project-gps">
                                    		<div class="cs-media">
                                                <figure>
                                                    <img src="{{ static_asset('assets/assets_web/extra-images/nimg31.jpeg')}}" alt="#">
                                                    <figcaption>
                                        ...
                                        <div class="cs-text">
                                            <p>
                                                ...
                                                Our care homes have now begun the process of offering the booster vaccine to all residents. The legislation makes vaccination mandatory for anyone who works in a care home, whatever their role. All care home residents will now be required to nominate up to 3 visitors who can enter the care home for regular visits. Visits must still be pre-booked, and visitors must test negative for COVID-19 at the start of the visit.
                                            </p>
                                            <p>
                                                Manav Sewa offers residential, nursing, dementia, respite, post-operative and palliative care. It can also offer a space for people to rest, relax and recover with daycare and short stays too. It also provide a Advance bookings facility for short stays available for a year. This large, elegantly converted house is situated in an attractive residential area just middle of Haryana. The building retains many original architectural features and the layout has a relaxed, homely atmosphere. The home is surrounded by beautiful grounds with lots of greenly views. All bedrooms are en-suite and are fully air-conditioned with fully facilities and several ground floor bedrooms have garden access and private patios. A hostess/servant/ caretaker service is also offered to give residents a truly personal service. The supportive staff team are available 24 hours a day to help with any requests from the residents, and clients are able to choose a local GP. Age is major reason for health damage of old person. So we also manage this topic. An optician, dentist and chiropodist also visit the home. Medical routine checkup always held on 2nd and 4th Sunday of every month.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
