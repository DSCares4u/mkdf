            ...
            <div class="col-md-4">
              ...
              <div class="col-md-6">
                <div>
                    ...
                    <a href="#" class="theme-btn btn-style-two w-100 d-block py-3 my-2"><i class="flaticon-next"></i><span>Click Here To Claim your 80(G)</span></a>
                    <a href="#" class="theme-btn btn-style-two w-100 d-block py-3 my-2"><i class="flaticon-next"></i><span>Donate Now</span></a>
                </div>
              </div>
                </div>
          </div>
