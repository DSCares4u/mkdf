        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="row row-sm">
                    ...
                    <div onclick="window.location.href='{{ url('admin/online-application-list') }}'" class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="my-auto">
                                    ...
                                    <div class="project-content">
                                        <h6>Online Janamdin Application</h6>
                                        <ul>
                                            <li>
                                                <strong>Total</strong>
                                                <span>{{$data['apply_online_count']}}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div onclick="window.location.href='{{ url('admin/donation-list') }}'" class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="my-auto">
                                    ...
                                    <div class="project-content">
                                        <h6>Total No. of Donation</h6>
                                        <ul>
                                            <li>
                                                <strong>Total</strong>
                                                <span>{{$data['donation_count']}}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="card overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="project-content">
                                        <h6>Total Amount of Donation</h6>
                                        <ul>
                                            <li>
                                                <strong>Total Rs. </strong>
                                                <span>{{$data['total_donation_amount']}}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
					...
					<div onclick="window.location.href='{{ url('admin/users/index') }}'" class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="my-auto">
                            ...
                            <div class="card-body p-0 m-scroll mh-350 mt-2">
                                <div class="list-group projects-list">
                                    <a   href="javascript:void(0);" class="list-group-item list-group-item-action flex-column align-items-start border-0 border-bottom">
                                        ...
                                        <p class="mb-0 text-muted  fs-12">Started:17-02-2020</p>
                                    ...
                                    <a   href="javascript:void(0);" class="list-group-item list-group-item-action flex-column align-items-start border-0 border-bottom">
                                        ...
                                        <p class="mb-0 text-muted fs-12">Started:15-02-2020</p>
                                        <small class="text-muted">Lorem ipsum dolor sit amet, consectetuer adipiscing elit..</small>
                                    </a>
                                    <a   href="javascript:void(0);" class="list-group-item list-group-item-action flex-column align-items-start border-0 border-bottom">
                                        <div class="d-flex w-100 justify-content-between">
                                        ...
                                        <p class="mb-0 text-muted fs-12">Started:26-02-2020</p>
                                        <small class="text-muted">Lorem ipsum dolor sit amet, consectetuer adipiscing elit..</small>
                                    </a>
