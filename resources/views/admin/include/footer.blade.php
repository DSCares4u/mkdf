...
<footer class="footer mt-auto py-3 bg-white text-center">
  <div class="container">
      <span class="text-muted"> Copyright © <span id="years">{{ date('Y') }}</span> <a
          ...
          Designed with <span class="bi bi-heart-fill text-danger"></span> by <a href="tel:8825171386">
              <span class="fw-semibold text-primary text-decoration-underline">Rana</span>
          </a> All
          rights
          reserved
      </span>
